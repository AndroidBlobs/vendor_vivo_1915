...
CUSTOM_HAL_IMGSENSOR=imx499pd1934_mipi_raw s5kgd1sppd1934_mipi_raw gc2375hpd1934_mipi_raw hi846pd1934_mipi_raw hi846pd1934v1_mipi_raw s5k3p9sp04pd1934_mipi_raw s5k3p9sp04pd1934v1_mipi_raw s5k3p9sp04pd1934v2_mipi_raw ov8856_mipi_raw
CUSTOM_HAL_LENS=dw9714af
CUSTOM_HAL_MAIN2_IMGSENSOR=gc2375hpd1934_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR=
CUSTOM_HAL_MAIN_BACKUP_LENS=
CUSTOM_HAL_MAIN_IMGSENSOR=imx499pd1934_mipi_raw
CUSTOM_HAL_MAIN_LENS=dw9714af
CUSTOM_HAL_MSENSORLIB = akm akl mmc
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR=
CUSTOM_HAL_SUB_BACKUP_LENS=
CUSTOM_HAL_SUB_IMGSENSOR=s5kgd1sppd1934_mipi_raw s5k3p9sp04pd1934_mipi_raw s5k3p9sp04pd1934v1_mipi_raw s5k3p9sp04pd1934v2_mipi_raw
CUSTOM_HAL_SUB_LENS=
...
CUSTOM_KERNEL_RAISEUP_DETECT = yes
CUSTOM_KERNEL_PUTDOWN_DETECT = yes
CUSTOM_KERNEL_ANGLE_JUDGE = yes
CUSTOM_KERNEL_AMD = yes
CUSTOM_KERNEL_ANGLE_DIRECTION_SENSOR = yes
CUSTOM_KERNEL_VIVOMOTION_DETECT = yes
CUSTOM_KERNEL_AMBIENT_LIGHT_SCENE_SENSOR =yes
...
CUSTOM_KERNEL_IMGSENSOR=imx499pd1934_mipi_raw s5kgd1sppd1934_mipi_raw gc2375hpd1934_mipi_raw hi846pd1934_mipi_raw hi846pd1934v1_mipi_raw s5k3p9sp04pd1934_mipi_raw s5k3p9sp04pd1934v1_mipi_raw s5k3p9sp04pd1934v2_mipi_raw ov8856_mipi_raw
...
CUSTOM_KERNEL_MAIN2_IMGSENSOR=gc2375hpd1934_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR=
CUSTOM_KERNEL_MAIN_BACKUP_LENS=
CUSTOM_KERNEL_MAIN_IMGSENSOR=imx499pd1934_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR=s5k3p9sp04pd1934_mipi_raw s5k3p9sp04pd1934v1_mipi_raw s5k3p9sp04pd1934v2_mipi_raw
...
CUSTOM_MODEM=BBK_P0MP3_K68V1_64_BSP_LWCTG_CUSTOM_BBKMake_PD1934F_EX_n
...
MTK_GPU_SUPPORT = yes
MTK_GPU_VERSION =mali bifrost r16p0
MTK_HAC_SUPPORT = no
...
MTK_PROTOCOL1_RAT_CONFIG=C/Lf/Lt/W/G
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_kernel_4-14 rel_customer_platform_mt6768 rel_customer_modem rel_customer_product_sp
...
MTK_LOW_MEMORY_HINT_SUPPORT = yes
MTK_DURASPEED_SUPPORT = no
MTK_GRAPHIC_LOW_LATENCY = no
MTK_VIDEO_TRANSITION = no
MTK_VIDEO_ENHANCEMENT = no
BBK_DRIVER_ONLY_ON=no
BBK_VIVO_ROM=rom_9.2
BBK_VIVO_ROM_VERSION=rom_9.2
BBK_VIVO_ROM_STYLE=vigour
BBK_VIVO_OS_NAME=Funtouch
BBK_VIVO_OS_VERSION=OS_9.2
BBK_VIVO_OS_REQ_VERSION=9.2
BBK_PRODUCT_SOLUTION=MTK
BBK_PRODUCT_SOLUTION_MTK=yes
BBK_PRODUCT_PLATFORM=MTK6768
BBK_TARGET_PRODUCT=full_k68v1_64
BBK_PRODUCT_BRAND=vivo
BBK_PRODUCT_MODEL=PD1934F_EX
BBK_PRODUCT_RELEASE_BRAND=vivo
BBK_PRODUCT_RELEASE_MODEL=1915
BBK_PRODUCT_RELEASE_NAME=1915
BBK_PRODUCT_VERSION=PD1934F_EX_A_1.9.4
BBK_PRODUCT_HARDWARE_VERSION=PD1934F_EXMA
BBK_HARDWARE_VERSION=PD1934F_EXMA
BBK_BOARD_VERSION=MA
BBK_OTA_ARGS=-n
VIVO_MP_VIVOLOCAPP_CONFIG=no
VIVO_MP_CONFIDENTIALITY_CONFIG=no
VIVO_MP_CONFIDENTIALITY_PROJECTS=PD1934F_EX:00
VIVO_MP_KEEP_INFO_SECRET_CONFIG=no
BBK_PRODUCT_LOCALES=en_US zh_CN zh_TW zh_HK th_TH ms_MY my_MM my_ZG in_ID bn_BD gu_IN mr_IN te_IN ta_IN hi_IN ur_PK tl_PH vi_VN lo_LA km_KH kn_IN ml_IN ru_RU ar_EG pa_IN or_IN as_IN bh_MA it_IT es_ES es_US si_LK pt_PT pt_BR ne_NP nl_NL fr_FR de_DE sa_IN ja_JP ko_KR zgh_MA sw_KE kk_KZ uk_UA pl_PL en_AU uz_UZ hdpi xxhdpi
BBK_OPERATOR_SOFTWARE_VERSION_NUMBER=07
BBK_FOR_NET_ENTRY=no
BBK_FOR_OP_ENTRY=no
BBK_TARGET_RELEASETOOLS_EXTENSIONS=vendor/vivo/build/releasetools/mtk/mt6768_9.0
BBK_AND_HARDWARE_VERSION=PD1934F_EXMA
BBK_PRODUCT_RADIO_TYPE_LIST=WCDMA,TDD-LTE,FDD-LTE,GSM
BBK_LTE_VOICE_TYPE=CSFB
BBK_SPEC_CUSTOM_APP=awox_dlna ifly_ivw30 OemDomainsConfig_domains fingerprint vivoCameraThirdpartyAlgo Nfc secureService SeedKeeper Vivodefend libvivo4dgamevibrator
BBK_PRODUCT_OVERSEAS=yes
BBK_SINGLE_APPSZIP=yes
BBK_LCM_XHD=FHD_19x5_9
BBK_PRODUCT_SERIES=VIVO
BBK_SF_LCD_DENSITY=480
CUSTOM_LK_LCM=pd1934_nt36672a_fhdplus_dsi_vdo_tm pd1934_ft8719_fhdplus_dsi_vdo_dijing pd1934_ft8719_fhdplus_dsi_vdo_truly pd1934_nt36672a_fhdplus_dsi_vdo_hx
VIVO_EYECARE_SUPPORT=1
VIVO_PD1934_PQ_COLOR=yes
MTK_ROUND_CORNER_SUPPORT=no
BBK_OEM_PROJECTS=PD1934F_EX_N_NULL_NULL PD1934F_EX_AE_NULL_NULL PD1934F_EX_BD_NULL_NULL PD1934F_EX_EG_NULL_NULL PD1934F_EX_ID_NULL_NULL PD1934F_EX_IN_NULL_NULL PD1934F_EX_KE_NULL_NULL PD1934F_EX_KZ_NULL_NULL PD1934F_EX_LK_NULL_NULL PD1934F_EX_MA_NULL_NULL PD1934F_EX_MM_NULL_NULL PD1934F_EX_NG_NULL_NULL PD1934F_EX_NP_NULL_NULL PD1934F_EX_PK_NULL_NULL PD1934F_EX_RU_NULL_NULL PD1934F_EX_TH_NULL_NULL PD1934F_EX_UA_NULL_NULL PD1934F_EX_VN_NULL_NULL PD1934F_EX_TW_NULL_NULL PD1934F_EX_SA_NULL_NULL PD1934F_EX_JO_NULL_NULL PD1934F_EX_SG_NULL_NULL PD1934F_EX_HK_NULL_NULL PD1934F_EX_AU_NULL_NULL PD1934F_EX_PH_NULL_NULL PD1934F_EX_KH_NULL_NULL PD1934F_EX_MY_NULL_NULL PD1934F_EX_UZ_NULL_NULL PD1934F_EX_TR_NULL_NULL PD1934F_EX_TZ_NULL_NULL PD1934F_EX_TH_NULL_AIS PD1934F_EX_TH_NULL_DTAC PD1934F_EX_TH_NULL_TRUE
BBK_OEM_PROJECT_LIST=PD1934F_EX
BBK_OEM_SUPPORT=yes
BBK_OEM_PROJECT_DEFAULT=PD1934F_EX_N_NULL_NULL
BBK_OEM_UP=
BBK_THIRD_PARTY_TO_DATA=yes
BBK_VOLTE_SUPPORT=yes
BBK_FOR_UNINSTALL=no
BBK_THIRD_PARTY_MODEL=
VIVO_FILE_INTEGRITY_CONFIG=yes
BBK_OBFUSCATE_CHECK=yes
BBK_PRODUCT_UPGRADE_LEVEL=1.2
...
VIVO_BQ25890H_FAST_CHARGING=yes
MTK_IPOH_SUPPORT=no
MTK_IPO_SUPPORT=no
BBK_PROPERTIYS_RO=
BBK_PROPERTIYS_OVERRIDES=ro.config.notification_sound=Whistle.ogg ro.config.alarm_alert=Fine_Day.ogg ro.config.message_sound=Default.ogg ro.config.ringtone=Blue_Meteor_Showers.ogg ro.kernel.android.checkjni=0 ro.ril.dtmf_interval=200 ro.ril.dtmf_pause_interval=100
MTK_CAM_PD1934=yes
MTK_CAM_CAM_DUMP_SUPPORT=yes
BBK_AUDIO=yes
BBK_FEATURE_MTK_KTV=yes
BBK_FEATURE_AUDIORECORD_CONTROL=yes
BBK_FEATURE_VRS=yes
BBK_AUDIO_VOLUME2=yes
BBK_AUDIO_ZENMODE=yes
BBK_AUDIO_DOUBLEMIC=yes
BBK_FEATURE_VAFX_MTK=no
AWINIC_AUDIO_EFFECT_SUPPORT=yes
BBK_FEATURE_VAFX_HP_AP=yes
BBK_FEATURE_POM=yes
BBK_AUDIO_FM_SWTICH_SPKMODE=yes
BBK_MEDIA_CORE=yes
BBK_MEDIA_EXTENSION=yes
BBK_FEATURE_MULTICHNVS=yes
BBK_FEATURE_VOICECHANGE=yes
BBK_FEATURE_GAME_VIBRATE=yes
WIFI_PARAMETER_PD1934F_EX=yes
FACE_DETECT_FIRM=FACE_ST
FACE_DETECT_OCULAR_SUPPORT=yes
BBK_SUPPORT_TF=yes
VIVO_SENSOR_USE_VLDO28=yes
